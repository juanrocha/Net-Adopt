...
[] Replace cat_commit for municipalities with NAs, and then run b1starmix because we want it centered on municipalities. It should read:
> b2starmix.2.cat_commit.NA.high   b2starmix.2.cat_commit.NA.low 

[] Use the gw1degree on municipalities. make sure to explore the decay on a short ergm.
